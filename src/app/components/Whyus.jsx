export default function Whyus(){
    return(
        <>
        <section className="text-gray-700 mt-[100px]">
  <h2 className="flex justify-center mt-10 text-4xl font-extrabold text-white sm:text-5xl">Why Me?</h2>


  <div className="container px-5 py-12 mx-auto">
    <div className="flex flex-wrap text-center justify-center">
      <div className="p-4 md:w-1/4 sm:w-1/2">
        <div className="px-4 py-6 transition-transform duration-500 hover:scale-110">
          ...
          <h2 className="text-2xl text-white">Latest Technology</h2>
        </div>
      </div>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2">
        <div className="px-4 py-6 transition-transform duration-500 hover:scale-110">
          ...
          <h2 className="text-2xl text-white">Time Efficiency</h2>
        </div>
      </div>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2">
        <div className="px-4 py-6 transition-transform duration-500 hover:scale-110">
          ...
          <h2 className="text-2xl text-white">Expert Developer</h2>
        </div>
      </div>
    </div>
  </div>
